#
# Configuration file used during the development of the neurow server
# It embed some pregerated keys to simplify the development and tests locally.
# These keys must not be used in other contexts
#
